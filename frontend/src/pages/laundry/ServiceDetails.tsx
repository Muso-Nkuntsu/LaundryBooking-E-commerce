...
const ServiceDetails: React.FC = () => {
  ...
  return (
    <div style={{ maxWidth: "640px", margin: "0 auto", padding: "clamp(16px, 4vw, 32px)", boxSizing: "border-box" }}>
      <button
        type="button"
        onClick={() => navigate(-1)}
        style={{
      ...
      {!loading && !error && service && (
        ...
        >
          ...
          >
            <div>
              <div style={{ fontFamily: type.body, fontSize: "12px", color: colors.textMuted }}>Price</div>
              <div style={{ fontFamily: type.display, fontSize: "20px", fontWeight: 700, color: colors.text }}>
            ...
            {service.durationMinutes !== undefined && (
              <div>
                <div style={{ fontFamily: type.body, fontSize: "12px", color: colors.textMuted }}>Duration</div>
                <div style={{ fontFamily: type.display, fontSize: "20px", fontWeight: 700, color: colors.text }}>
